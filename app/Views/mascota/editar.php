<?= view('commons/head.php') ?>
    ...
    <div id="add-modal" tabindex="-1" aria-hidden="false" class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-screen flex items-center justify-center bg-slate-900/75">
                    ...
                    <form class="space-y-6" action="<?= base_url('mascotas/actualizar/')?>" method="post">
                        ...
                        <div>
                            ...
                            <?php foreach ($especies as $especie) : ?>
                                    <option <?php echo ($especie['nombre'] == $mascota[0]['especie'] ) ? 'selected' : '';   ?> value="<?php echo $especie['id'] ?>"><?php echo $especie['nombre'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div>
                            ...
                            <select id="raza" name="raza" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                <?php foreach ($razas as $raza) : ?>
                                    <option <?php echo ($raza['nombre'] == $mascota[0]['raza'] ) ? 'selected' : '';   ?> value="<?php echo $raza['id'] ?>"><?php echo $raza['nombre'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div>
                            ...
                            <select id="dieta" name="dieta" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                <?php foreach ($dietas as $dieta) : ?>
                                    <option <?php echo ($dieta['nombre'] == $mascota[0]['dieta'] ) ? 'selected' : '';   ?> value="<?php echo $dieta['id'] ?>"><?php echo $dieta['nombre'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
