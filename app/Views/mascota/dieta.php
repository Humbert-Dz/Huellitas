        ...
        <div id="popup-modal" tabindex="-1" class="z-50 p-4 overflow-x-hidden min-w-[500px]">
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Dieta: <?php echo $dietaInfo[0]['dieta_nombre'] ?> </h3>
                        <hr>
                        <div class="text-white text-lg py-4">
                            <p>#ID dieta: <?php echo $dietaInfo[0]['id'] ?> </p>
                            <br>
                            <h2>Ingredientes:</h2>
                            <ul>
                                <?php foreach($dietaInfo as $dieta): ?>
                                    <li>
                                        <?php echo $dieta['ingrediente'] . '( ' . $dieta['porcion'] . 'gr )'?>
                                    </li>
                                <?php endforeach ?>
                            </ul>
                            <br>
                            <p>
                            <h2>Preparación:</h2>
                            <?php echo $dietaInfo[0]['descripcion'] ?>
                            </p>
                        </div>
